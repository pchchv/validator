...
// getStructFieldOKInternal traverses a struct to retrieve a specific field denoted by the
// provided namespace and returns the field,
// field kind and whether is was successful in retrieving the field at all.
//
...
// asFloat64 returns the parameter as a float64 or panics if it can't convert.
...
// asFloat32 returns the parameter as a float32 or panics if it can't convert.
